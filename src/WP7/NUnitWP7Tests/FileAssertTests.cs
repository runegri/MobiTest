...
namespace NUnit.Framework.Tests
{
	public class TestFile : IDisposable
	{
		...
		{
            throw new NotImplementedException("TestFile is not ready!");
			_resourceName = "/NUnitWP7Tests;component/data/" + resourceName;
			_fileName = fileName;

			using (Stream s = Application.GetResourceStream(new Uri(_resourceName, UriKind.Relative)).Stream)
			{
